...
| 文法/措辞系统 | `Sources/RimSearcher.Tests/GrammarRules.cs`、`Core/CountedNoun.cs`、`Core/OutputText.cs` | 与数据源完全无关,整体移植 |
| 字节级基线方法 | `Sources/RimSearcher.Tests/OutputSnapshotTests.cs` + `Snapshots/` | 「先立字节级闸再改代码」的载体;基线份数基准见 M1 落账(61→73) |
