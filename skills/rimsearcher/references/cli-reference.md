...
For who calls a method, 'callers'; for what a type derives from and what derives from it, 'types'. Both read the assembly's metadata. This command answers a different question: what the decompiled file on disk actually says.
